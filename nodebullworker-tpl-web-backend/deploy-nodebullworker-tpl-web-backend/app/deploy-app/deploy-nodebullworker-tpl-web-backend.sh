...
deploy_app() {
    ...
    export NODEBULLWORKER_TPL_WEB_BACKEND_IMAGE_PROJECT="${NODEBULLWORKER_TPL_WEB_BACKEND_IMAGE_PROJECT:-app-images}"
    ...
    log_info "生成并部署 PVC..."
    auto_generate_yaml "$NODEBULLWORKER_TPL_WEB_BACKEND_PVC_YAML" "$K8S_RESOURCE_DIR" || return 1
