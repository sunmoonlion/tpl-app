...
export TPL_ADMIN_BACKEND_OBJECT_STORAGE_CONFIGMAP_NAME="${TPL_ADMIN_BACKEND_OBJECT_STORAGE_CONFIGMAP_NAME:-}"
export TPL_ADMIN_BACKEND_OBJECT_STORAGE_SECRET_NAME="${TPL_ADMIN_BACKEND_OBJECT_STORAGE_SECRET_NAME:-}"
export TPL_ADMIN_BACKEND_ELASTICSEARCH_CONFIGMAP_NAME="${TPL_ADMIN_BACKEND_ELASTICSEARCH_CONFIGMAP_NAME:-}"
export TPL_ADMIN_BACKEND_ELASTICSEARCH_SECRET_NAME="${TPL_ADMIN_BACKEND_ELASTICSEARCH_SECRET_NAME:-}"
export TPL_ADMIN_BACKEND_POSTGRESQL_SECRET_NAME="${TPL_ADMIN_BACKEND_POSTGRESQL_SECRET_NAME:-}"
export TPL_ADMIN_BACKEND_REDIS_SECRET_NAME="${TPL_ADMIN_BACKEND_REDIS_SECRET_NAME:-}"
export TPL_ADMIN_BACKEND_MONGODB_SECRET_NAME="${TPL_ADMIN_BACKEND_MONGODB_SECRET_NAME:-}"
export PVC_NAME="${PVC_NAME:-}"
export PVC_MOUNT_PATH="${PVC_MOUNT_PATH:-}"
export PVC_SUB_PATH="${PVC_SUB_PATH:-}"

TPL_ADMIN_BACKEND_DATABASE_ENV_FROM=""
if [ -n "$TPL_ADMIN_BACKEND_POSTGRESQL_SECRET_NAME" ]; then
    TPL_ADMIN_BACKEND_DATABASE_ENV_FROM="${TPL_ADMIN_BACKEND_DATABASE_ENV_FROM}
        - secretRef:
            name: ${TPL_ADMIN_BACKEND_POSTGRESQL_SECRET_NAME}"
fi
if [ -n "$TPL_ADMIN_BACKEND_REDIS_SECRET_NAME" ]; then
    TPL_ADMIN_BACKEND_DATABASE_ENV_FROM="${TPL_ADMIN_BACKEND_DATABASE_ENV_FROM}
        - secretRef:
            name: ${TPL_ADMIN_BACKEND_REDIS_SECRET_NAME}"
fi
if [ -n "$TPL_ADMIN_BACKEND_MONGODB_SECRET_NAME" ]; then
    TPL_ADMIN_BACKEND_DATABASE_ENV_FROM="${TPL_ADMIN_BACKEND_DATABASE_ENV_FROM}
        - secretRef:
            name: ${TPL_ADMIN_BACKEND_MONGODB_SECRET_NAME}"
fi
export TPL_ADMIN_BACKEND_DATABASE_ENV_FROM

TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM=""
if [ -n "$TPL_ADMIN_BACKEND_OBJECT_STORAGE_CONFIGMAP_NAME" ]; then
    TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM="${TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM}
        - configMapRef:
            name: ${TPL_ADMIN_BACKEND_OBJECT_STORAGE_CONFIGMAP_NAME}"
fi
if [ -n "$TPL_ADMIN_BACKEND_OBJECT_STORAGE_SECRET_NAME" ]; then
    TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM="${TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM}
        - secretRef:
            name: ${TPL_ADMIN_BACKEND_OBJECT_STORAGE_SECRET_NAME}"
fi
export TPL_ADMIN_BACKEND_OBJECT_STORAGE_ENV_FROM

TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM=""
if [ -n "$TPL_ADMIN_BACKEND_ELASTICSEARCH_CONFIGMAP_NAME" ]; then
    TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM="${TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM}
        - configMapRef:
            name: ${TPL_ADMIN_BACKEND_ELASTICSEARCH_CONFIGMAP_NAME}"
fi
if [ -n "$TPL_ADMIN_BACKEND_ELASTICSEARCH_SECRET_NAME" ]; then
    TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM="${TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM}
        - secretRef:
            name: ${TPL_ADMIN_BACKEND_ELASTICSEARCH_SECRET_NAME}"
fi
export TPL_ADMIN_BACKEND_ELASTICSEARCH_ENV_FROM
